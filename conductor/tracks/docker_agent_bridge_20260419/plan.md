...
- [ ] Task: Conductor - User Manual Verification 'Phase 1: Project Setup & Scaffolding' (Protocol in workflow.md)

## Phase 2: Model & Provider Initialization
- [ ] Task: Write tests for model resolution
- [ ] Task: Implement parser for `providers` and `models` YAML blocks
- [ ] Task: Conductor - User Manual Verification 'Phase 2: Model & Provider Initialization' (Protocol in workflow.md)

## Phase 3: Tool and MCP Mapping
...
- [ ] Task: Conductor - User Manual Verification 'Phase 3: Tool and MCP Mapping' (Protocol in workflow.md)

## Phase 4: Agent Orchestration
- [ ] Task: Write tests for sub-agent and root agent generation
- [ ] Task: Implement logic to dynamically build LangGraph agents
- [ ] Task: Conductor - User Manual Verification 'Phase 4: Agent Orchestration' (Protocol in workflow.md)

## Phase 5: CLI Entry Point and Documentation
- [ ] Task: Implement `main.py` execution entry point
- [ ] Task: Create sample `team.yaml`
- [ ] Task: Write `README.md` documentation
- [ ] Task: Conductor - User Manual Verification 'Phase 5: CLI Entry Point and Documentation' (Protocol in workflow.md)
